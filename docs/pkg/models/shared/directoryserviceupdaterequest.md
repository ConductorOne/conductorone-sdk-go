...
| `DirectoryMergeConfig`                                                                       | [*shared.DirectoryMergeConfig](../../../pkg/models/shared/directorymergeconfig.md)           | :heavy_minus_sign:                                                                           | DirectoryMergeConfig configures how AppUsers from this directory are matched to C1 Users.    |