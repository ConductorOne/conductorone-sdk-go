...
| `Literal`                                                                                                                            | **bool*                                                                                                                              | :heavy_minus_sign:                                                                                                                   | The literal field.<br/>This field is part of the `value` oneof.<br/>See the documentation for `c1.api.a2ui.v1.DynamicBool` for more details. |
