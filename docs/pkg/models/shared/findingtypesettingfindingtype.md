...
| `FindingTypeSettingFindingTypeFindingTypeShadowApp`                         | FINDING_TYPE_SHADOW_APP                                                     |
| `FindingTypeSettingFindingTypeFindingTypeMcpGatewayToolCallRisk`            | FINDING_TYPE_MCP_GATEWAY_TOOL_CALL_RISK                                     |