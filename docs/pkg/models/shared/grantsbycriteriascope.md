...
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| `AccessProfileFilter`                                                                      | [*shared.GrantAccessProfileFilter](../../../pkg/models/shared/grantaccessprofilefilter.md) | :heavy_minus_sign:                                                                         | N/A                                                                                        |
...
| `GrantsAddedBetween`                                                                       | [*shared.GrantsAddedBetween](../../../pkg/models/shared/grantsaddedbetween.md)             | :heavy_minus_sign:                                                                         | N/A                                                                                        |
