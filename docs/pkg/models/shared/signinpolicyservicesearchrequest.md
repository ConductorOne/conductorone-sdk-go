# SignInPolicyServiceSearchRequest
...
| `Refs`                                                                    | [][shared.SignInPolicyRef](../../../pkg/models/shared/signinpolicyref.md) | :heavy_minus_sign:                                                        | Restrict results to these specific policies. Empty matches all policies.  |