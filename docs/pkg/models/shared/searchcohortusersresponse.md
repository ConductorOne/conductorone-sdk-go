...
| `UsersWithCoverage`                                                                     | [][shared.CohortUserWithCoverage](../../../pkg/models/shared/cohortuserwithcoverage.md) | :heavy_minus_sign:                                                                      | Per-user coverage counts, populated when selected_entitlements is non-empty.            |