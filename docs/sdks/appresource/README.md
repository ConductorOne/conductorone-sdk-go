...
* [AppResourceSvcGet](#appresourcesvcget) - Invokes the c1.api.app.v1.AppResourceService.Get method.
...
func main() {
    ...
    res, err := s.AppResource.AppResourceSvcGet(ctx, operations.C1APIAppV1AppResourceServiceGetRequest{
        AppID: "at",
