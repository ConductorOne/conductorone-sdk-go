...
* [TaskSvcCreateGrantTask](#tasksvccreategranttask) - Invokes the c1.api.task.v1.TaskService.CreateGrantTask method.
* [TaskSvcCreateRevokeTask](#tasksvccreaterevoketask) - Invokes the c1.api.task.v1.TaskService.CreateRevokeTask method.
* [TaskSvcGet](#tasksvcget) - Invokes the c1.api.task.v1.TaskService.Get method.

## TaskSvcCreateGrantTask
...
func main() {
    ...
    res, err := s.Task.TaskSvcCreateGrantTask(ctx, shared.TaskServiceCreateGrantRequest{
        ...
        GrantDuration: conductoroneapi.String("doloremque"),
        IdentityUserID: conductoroneapi.String("reprehenderit"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Task.TaskSvcCreateRevokeTask(ctx, shared.TaskServiceCreateRevokeRequest{
        AppEntitlementID: conductoroneapi.String("ut"),
        AppID: conductoroneapi.String("maiores"),
        AppUserID: conductoroneapi.String("dicta"),
        Description: conductoroneapi.String("corporis"),
        ExpandMask: &shared.TaskExpandMask{
            Paths: []string{
                "iusto",
                "dicta",
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Task.TaskSvcGet(ctx, operations.C1APITaskV1TaskServiceGetRequest{
