...
Delete soft-deletes an Edge and cascades its minted entitlement
 stack. Egress requests 404 immediately; re-creating the Edge mints an
 all-new stack.
...
Update edits an Edge's mode and audience_client_ids via update_mask.
