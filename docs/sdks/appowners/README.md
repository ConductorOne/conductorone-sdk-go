...
<!-- UsageSnippet language="go" operationID="c1.api.app.v1.AppOwners.Delete" method="delete" path="/api/v1/apps/{app_id}/owners" -->
```go
package main
...
func main() {
    ...
    res, err := s.AppOwners.Delete(ctx, operations.C1APIAppV1AppOwnersDeleteRequest{
        AppID: "<id>",
    })
    if err != nil {
        log.Fatal(err)
    }
    if res.DeleteAppOwnersResponse != nil {
        // handle response
    }
}
```
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| `ctx`                                                                                                          | [context.Context](https://pkg.go.dev/context#Context)                                                          | :heavy_check_mark:                                                                                             | The context to use for the request.                                                                            |
| `request`                                                                                                      | [operations.C1APIAppV1AppOwnersDeleteRequest](../../pkg/models/operations/c1apiappv1appownersdeleterequest.md) | :heavy_check_mark:                                                                                             | The request object to use for the request.                                                                     |
| `opts`                                                                                                         | [][operations.Option](../../pkg/models/operations/option.md)                                                   | :heavy_minus_sign:                                                                                             | The options for this request.                                                                                  |

### Response

**[*operations.C1APIAppV1AppOwnersDeleteResponse](../../pkg/models/operations/c1apiappv1appownersdeleteresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="c1.api.app.v1.AppOwners.ListOwnerIDs" method="get" path="/api/v1/apps/{app_id}/ownerids" -->
```go
package main
...
func main() {
    ...
    res, err := s.AppOwners.ListOwnerIDs(ctx, operations.C1APIAppV1AppOwnersListOwnerIDsRequest{
        AppID: "<id>",
    })
    if err != nil {
        log.Fatal(err)
...
| -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `ctx`                                                                                                                      | [context.Context](https://pkg.go.dev/context#Context)                                                                      | :heavy_check_mark:                                                                                                         | The context to use for the request.                                                                                        |
| `request`                                                                                                                  | [operations.C1APIAppV1AppOwnersListOwnerIDsRequest](../../pkg/models/operations/c1apiappv1appownerslistowneridsrequest.md) | :heavy_check_mark:                                                                                                         | The request object to use for the request.                                                                                 |
| `opts`                                                                                                                     | [][operations.Option](../../pkg/models/operations/option.md)                                                               | :heavy_minus_sign:                                                                                                         | The options for this request.                                                                                              |

### Response

**[*operations.C1APIAppV1AppOwnersListOwnerIDsResponse](../../pkg/models/operations/c1apiappv1appownerslistowneridsresponse.md), error**
