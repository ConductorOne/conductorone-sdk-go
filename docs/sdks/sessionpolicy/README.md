...
* [SearchAppUserSessionPolicies](#searchappusersessionpolicies) - Search App User Session Policies
...
<!-- UsageSnippet language="go" operationID="c1.api.session_policy.v1.SessionPolicyService.SearchAppUserSessionPolicies" method="post" path="/api/v1/apps/{app_id}/entitlements/{app_entitlement_id}/session-policies/search" -->
```go
package main
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ctx`                                                                                                                                                                                                | [context.Context](https://pkg.go.dev/context#Context)                                                                                                                                                | :heavy_check_mark:                                                                                                                                                                                   | The context to use for the request.                                                                                                                                                                  |
| `request`                                                                                                                                                                                            | [operations.C1APISessionPolicyV1SessionPolicyServiceSearchAppUserSessionPoliciesRequest](../../pkg/models/operations/c1apisessionpolicyv1sessionpolicyservicesearchappusersessionpoliciesrequest.md) | :heavy_check_mark:                                                                                                                                                                                   | The request object to use for the request.                                                                                                                                                           |
| `opts`                                                                                                                                                                                               | [][operations.Option](../../pkg/models/operations/option.md)                                                                                                                                         | :heavy_minus_sign:                                                                                                                                                                                   | The options for this request.                                                                                                                                                                        |

### Response

**[*operations.C1APISessionPolicyV1SessionPolicyServiceSearchAppUserSessionPoliciesResponse](../../pkg/models/operations/c1apisessionpolicyv1sessionpolicyservicesearchappusersessionpoliciesresponse.md), error**
