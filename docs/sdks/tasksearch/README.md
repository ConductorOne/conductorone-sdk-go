...
* [TaskSearchSvcSearch](#tasksearchsvcsearch) - Invokes the c1.api.task.v1.TaskSearchService.Search method.
...
func main() {
    ...
    res, err := s.TaskSearch.TaskSearchSvcSearch(ctx, shared.TaskSearchRequest{
