...
func main() {
    ...
    if res.PolicyEditorValidateResponse != nil {
        // handle response
    }
}
```
...
| `request`                                                                                    | [shared.PolicyEditorValidateRequest](../../pkg/models/shared/policyeditorvalidaterequest.md) | :heavy_check_mark:                                                                           | The request object to use for the request.                                                   |
