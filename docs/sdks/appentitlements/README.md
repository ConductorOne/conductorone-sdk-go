...
* [AppEntitlementsGet](#appentitlementsget) - Invokes the c1.api.app.v1.AppEntitlements.Get method.
...
func main() {
    ...
    res, err := s.AppEntitlements.AppEntitlementsGet(ctx, operations.C1APIAppV1AppEntitlementsGetRequest{
        AppID: "corrupti",
