...
// Generated from OpenAPI doc version 0.1.0-alpha and generator version 2.648.7
...
func New(opts ...SDKOption) *ConductoroneAPI {
	sdk := &ConductoroneAPI{
		SDKVersion: "1.25.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.25.0 2.648.7 0.1.0-alpha github.com/conductorone/conductorone-sdk-go",
