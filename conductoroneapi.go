...
// Generated from OpenAPI doc version 0.1.0-alpha and generator version 2.858.2
...
func New(opts ...SDKOption) *ConductoroneAPI {
	sdk := &ConductoroneAPI{
		SDKVersion: "1.26.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.26.2 2.858.2 0.1.0-alpha github.com/conductorone/conductorone-sdk-go",
