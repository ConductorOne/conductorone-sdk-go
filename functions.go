...
func (s *Functions) UpdateFunction(ctx context.Context, request operations.C1APIFunctionsV1FunctionsServiceUpdateFunctionRequest, opts ...operations.Option) (*operations.C1APIFunctionsV1FunctionsServiceUpdateFunctionResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "FunctionsServiceUpdateFunctionRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
