...
// TaskActionsSvcApprove - Invokes the c1.api.task.v1.TaskActionsService.Approve method.
func (s *taskActions) TaskActionsSvcApprove(ctx context.Context, request operations.C1APITaskV1TaskActionsServiceApproveRequest) (*operations.C1APITaskV1TaskActionsServiceApproveResponse, error) {
...
// TaskActionsSvcComment - Invokes the c1.api.task.v1.TaskActionsService.Comment method.
func (s *taskActions) TaskActionsSvcComment(ctx context.Context, request operations.C1APITaskV1TaskActionsServiceCommentRequest) (*operations.C1APITaskV1TaskActionsServiceCommentResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
// TaskActionsSvcDeny - Invokes the c1.api.task.v1.TaskActionsService.Deny method.
func (s *taskActions) TaskActionsSvcDeny(ctx context.Context, request operations.C1APITaskV1TaskActionsServiceDenyRequest) (*operations.C1APITaskV1TaskActionsServiceDenyResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
