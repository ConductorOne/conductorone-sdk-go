...
const (
	...
	FindingTypeFindingTypeShadowApp                         FindingType = "FINDING_TYPE_SHADOW_APP"
	FindingTypeFindingTypeMcpGatewayToolCallRisk            FindingType = "FINDING_TYPE_MCP_GATEWAY_TOOL_CALL_RISK"
)
