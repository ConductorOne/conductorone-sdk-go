...
// AppEntitlementsGet - Invokes the c1.api.app.v1.AppEntitlements.Get method.
func (s *appEntitlements) AppEntitlementsGet(ctx context.Context, request operations.C1APIAppV1AppEntitlementsGetRequest) (*operations.C1APIAppV1AppEntitlementsGetResponse, error) {
