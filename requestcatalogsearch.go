...
// RequestCatalogSearchSvcSearchEntitlements - Invokes the c1.api.requestcatalog.v1.RequestCatalogSearchService.SearchEntitlements method.
func (s *requestCatalogSearch) RequestCatalogSearchSvcSearchEntitlements(ctx context.Context, request shared.RequestCatalogSearchServiceSearchEntitlementsRequest) (*operations.C1APIRequestcatalogV1RequestCatalogSearchServiceSearchEntitlementsResponse, error) {
