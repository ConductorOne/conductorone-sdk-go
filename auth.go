...
// AuthIntrospect - Invokes the c1.api.auth.v1.Auth.Introspect method.
func (s *auth) AuthIntrospect(ctx context.Context) (*operations.C1APIAuthV1AuthIntrospectResponse, error) {
