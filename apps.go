...
// AppsGet - Invokes the c1.api.app.v1.Apps.Get method.
func (s *apps) AppsGet(ctx context.Context, request operations.C1APIAppV1AppsGetRequest) (*operations.C1APIAppV1AppsGetResponse, error) {
