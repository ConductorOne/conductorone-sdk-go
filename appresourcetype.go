...
// AppResourceTypeSvcGet - Invokes the c1.api.app.v1.AppResourceTypeService.Get method.
func (s *appResourceType) AppResourceTypeSvcGet(ctx context.Context, request operations.C1APIAppV1AppResourceTypeServiceGetRequest) (*operations.C1APIAppV1AppResourceTypeServiceGetResponse, error) {
